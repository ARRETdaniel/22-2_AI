...
\chapter{Objetivo em Etapas} \label{etapas}
...
Este cronograma visa mostrar o desenvolvimento das atividades (listadas na seção \textbf{\ref{etapas}}), cada etapa foi dividido de modo a otimizar o tempo e as necessidades do projeto.
\begin{table}[H]
\centering
\resizebox{\textwidth}{!}{%
